...
def mark_your_attendance(request):
	...
	vs = VideoStream(src=0).start()
	#frame = cv2.imread('/home/legacy/Desktop/13.jpg')

	#frame = cv2.imread('/home/legacy/Desktop/testt.jpg')
	...
	for i in range(0,10):
		...
		for face in faces:
			...
			if(pred!=[-1]):
				print("DEtected_________________________")
